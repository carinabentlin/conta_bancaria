...
1. Clone o repositório do Projeto [Conta Bancária](https://github.com/carinabentlin/conta_bancaria.git) dentro da pasta do *Workspace* do Eclipse/STS

```bash
https://github.com/carinabentlin/conta_bancaria.git
```
...
Desenvolvido por [**Carina**](https://github.com/carinabentlin/conta_bancaria.git)
